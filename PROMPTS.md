...
### Prompt 2
run this project locally for testing before we build
...
### Prompt 6
I didn't say simply the version of DesignJoy I said clone the code it's already there, you don't have to be creative or anything, just clone that code, and I asked you to only change DesignJoy to SiteGuru, that's the only change, the rest needs to be cloned as is word to word, pixel to pixel, everything!

### Prompt 7
you missing the animations, some of the elements are a bit off, and alignment thereof, the two border lines on the left and right of where the page width starts and ends are cutting through the content, whereas the original clone thre's a padding before and after the content.
...
this is all in the clone folder all the code is there to copy

### Prompt 8
our width is 1200 but our content doesn't start there becuase there's a padding, remove that padding and content should but against 1200 containter.

don't change the layout of the original design, things are now all over the place, look closely at the clone folder and make sure that you implement that as is.

don't alter design from the original code, pay attention to the font weight throughout your document.

create a md file and save all the prompts I give you there
